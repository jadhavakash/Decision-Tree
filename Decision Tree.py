...
#-------------For Decision Tree and confusion matrix---------------------
...
#------------------------Decision Tree Visualization
        ...
        import pydotplus
#-----------------------------------------Starting from Data Import--------------------

#Importing the dataset
        df = pd.read_csv("C:/Users/Akash/PycharmProjects/akash/CSV/churn.csv")
        df
...
"""Additional info.
    Creating classifier Tree with entropy method.
    Also how to handle Regression tree ( When target var is numeric)
    Use Regression instead of classifier
"""


# Creating the classifier object with chosen criterion
    # regressor_entropy = DecisionTreeClassifier(criterion="entropy", random_state=100, max_depth=3, min_samples_leaf=5)
    # regressor_entropy.fit(x_train, y_train)
    # y_pred = regressor_entropy.predict(x_test)
